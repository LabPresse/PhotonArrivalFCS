...
Re-pitching single focus confocal data analysis one photon at a time with 
...
ASWFCS described in the following publication:
    ...
    Re-pitching single focus confocal data analysis one photon at a time 
with Bayesian nonparametrics.

    Meysam Tavakoli, Sina Jazani, Ioannis Sgouralis, Omer M. Shafraz, 
Bryan Donaphon, Sanjeevi Sivasankar, Marcia Levitus, and Steve Presse
...
1) To use this software in GUI form run: PhotonArrivalFCS in Matlab's 
command window.
